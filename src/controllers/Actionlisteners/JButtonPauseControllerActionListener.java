...
public class JButtonPauseControllerActionListener implements ActionListener {
	...
	public JButtonPauseControllerActionListener(JAlphaNotationGUI gui, JModel model, JController controller) {
		this.gui = gui;
		this.model = model;
